...
export const Loader: React.FC<IIcon> = ({ width, height, fill, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width || 24}
...
export const Close: React.FC<IIcon> = ({ width, height, fill, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width || 24}
...
export const Clipboard: React.FC<IIcon> = ({
  width,
  height,
  fill,
  ...props
...
export const ChevronRight: React.FC<IIcon> = ({
  width,
  height,
  fill,
  ...props
...
export const ChevronDown: React.FC<IIcon> = ({
  width,
  height,
  fill,
  ...props
